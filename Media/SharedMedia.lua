...
LSM:Register("statusbar", "ArmorCastBar", [[Interface\Addons\Mila_UI\Textures\Statusbars\ArmorCastBar.tga]])
LSM:Register("statusbar", "HPredHD2", [[Interface\Addons\Mila_UI\Textures\Statusbars\HPredHD2.tga]])
LSM:Register("statusbar", "shield-fill", [[Interface\Addons\Mila_UI\Textures\shield-fill.tga]])
LSM:Register("statusbar", "HPYellowHD", [[Interface\Addons\Mila_UI\Textures\HPYellowHD.tga]])
LSM:Register("statusbar", "MirroredFrameSingleBG", [[Interface\Addons\Mila_UI\Textures\MirroredFrameSingleBG.tga]])