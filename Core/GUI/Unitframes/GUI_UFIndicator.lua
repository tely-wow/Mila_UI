...
function MilaUI:DrawIndicatorContainer(dbUnitName, MilaUI_GUI_Container)
    ...
    TargetMarkerSize:SetCallback("OnValueChanged", function(widget, event, value) TargetMarker.Size = value MilaUI:UpdateIndicator() end)
    ...
    TargetMarkerAnchorFrom:SetCallback("OnValueChanged", function(widget, event, value) TargetMarker.AnchorFrom = value MilaUI:UpdateIndicator() end)
    ...
    TargetMarkerAnchorTo:SetCallback("OnValueChanged", function(widget, event, value) TargetMarker.AnchorTo = value MilaUI:UpdateIndicator() end)
    ...
    TargetMarkerXOffset:SetCallback("OnValueChanged", function(widget, event, value) TargetMarker.XOffset = value MilaUI:UpdateIndicator() end)
    ...
    TargetMarkerYOffset:SetCallback("OnValueChanged", function(widget, event, value) TargetMarker.YOffset = value MilaUI:UpdateIndicator() end)
    ...
    if dbUnitName == "Player" then
        ...
        CombatIndicatorSize:SetCallback("OnValueChanged", function(widget, event, value) CombatIndicator.Size = value MilaUI:UpdateIndicator() end)
        ...
        CombatIndicatorAnchorFrom:SetCallback("OnValueChanged", function(widget, event, value) CombatIndicator.AnchorFrom = value MilaUI:UpdateIndicator() end)
        ...
        CombatIndicatorAnchorTo:SetCallback("OnValueChanged", function(widget, event, value) CombatIndicator.AnchorTo = value MilaUI:UpdateIndicator() end)
        ...
        CombatIndicatorXOffset:SetCallback("OnValueChanged", function(widget, event, value) CombatIndicator.XOffset = value MilaUI:UpdateIndicator() end)
        ...
        CombatIndicatorYOffset:SetCallback("OnValueChanged", function(widget, event, value) CombatIndicator.YOffset = value MilaUI:UpdateIndicator() end)
    ...
    LeaderIndicatorSize:SetCallback("OnValueChanged", function(widget, event, value) LeaderIndicator.Size = value MilaUI:UpdateIndicator() end)
    ...
    LeaderIndicatorAnchorFrom:SetCallback("OnValueChanged", function(widget, event, value) LeaderIndicator.AnchorFrom = value MilaUI:UpdateIndicator() end)
    ...
    LeaderIndicatorAnchorTo:SetCallback("OnValueChanged", function(widget, event, value) LeaderIndicator.AnchorTo = value MilaUI:UpdateIndicator() end)
    ...
    LeaderIndicatorXOffset:SetCallback("OnValueChanged", function(widget, event, value) LeaderIndicator.XOffset = value MilaUI:UpdateIndicator() end)
    ...
    LeaderIndicatorYOffset:SetCallback("OnValueChanged", function(widget, event, value) LeaderIndicator.YOffset = value MilaUI:UpdateIndicator() end)
