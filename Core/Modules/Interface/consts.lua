...
local function GetPlayerRole()
    ...
    if assignedRole == "NONE" then
        return MilaUI.myspec and GetSpecializationRole(MilaUI.myspec)
    end

    return assignedRole
end
MilaUI.GetPlayerRole = GetPlayerRole

local function CheckRole()
    MilaUI.myspec = GetSpecialization()
    MilaUI.myrole = GetPlayerRole()

    -- myrole = group role; TANK, HEALER, DAMAGER
end
MilaUI.CheckRole = CheckRole
MilaUI.screenwidth, MilaUI.screenHeight = GetPhysicalScreenSize()
MilaUI.resolution = format("%dx%d", MilaUI.screenwidth, MilaUI.screenHeight)
-- Constants
MilaUI.myguid = UnitGUID("player")
MilaUI.NoOp = function() end
MilaUI.myfaction = UnitFactionGroup("player")
MilaUI.myclass, MilaUI.myClassID = UnitClass("player")
MilaUI.myrace = UnitRace("player")
MilaUI.myname = UnitName("player")
MilaUI.myrealm = GetRealmName()
MilaUI.mysex = UnitSex("player")
MilaUI.mylevel = UnitLevel("player")
MilaUI.myspec = GetSpecialization()
MilaUI.myrole = GetPlayerRole()
MilaUI.CheckRole()
MilaUI.texts = {}
...
MilaUI.CLASS_ICONS.WARRIOR = MilaUI.CLASS_ICONS[1]
MilaUI.CLASS_ICONS.PALADIN = MilaUI.CLASS_ICONS[2]
MilaUI.CLASS_ICONS.HUNTER = MilaUI.CLASS_ICONS[3]
MilaUI.CLASS_ICONS.ROGUE = MilaUI.CLASS_ICONS[4]
MilaUI.CLASS_ICONS.PRIEST = MilaUI.CLASS_ICONS[5]
MilaUI.CLASS_ICONS.DEATHKNIGHT = MilaUI.CLASS_ICONS[6]
MilaUI.CLASS_ICONS.SHAMAN = MilaUI.CLASS_ICONS[7]
MilaUI.CLASS_ICONS.MAGE = MilaUI.CLASS_ICONS[8]
MilaUI.CLASS_ICONS.WARLOCK = MilaUI.CLASS_ICONS[9]
MilaUI.CLASS_ICONS.MONK = MilaUI.CLASS_ICONS[10]
MilaUI.CLASS_ICONS.DRUID = MilaUI.CLASS_ICONS[11]
MilaUI.CLASS_ICONS.DEMONHUNTER = MilaUI.CLASS_ICONS[12]
MilaUI.CLASS_ICONS.EVOKER = MilaUI.CLASS_ICONS[13]
...
MilaUI.INDICATORS = { "BAR", "TOPLEFT", "TOP", "TOPRIGHT", "LEFT", "CENTER", "RIGHT" }
MilaUI.indicatorsText = { "Bar", "Top Left", "Top", "Top Right", "Left", "Center", "Right" }
...
MilaUI.WINDOW_FADE_DURATION = 0.2
