...
local function Titles_InitButton(button, elementData)
    ...
    if not button.isSkinned then
        button.name:GwSetFontTemplate(UNIT_NAME_FONT, MilaUI.TextSizeType.SMALL)
...
local function LoadPDTitles(fmMenu, parent)
    ...
    MilaUI.HandleTrimScrollBar(titlewin.ScrollBar)
    MilaUI.HandleScrollControls(titlewin)
...
MilaUI.LoadPDTitles = LoadPDTitles